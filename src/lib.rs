...
// shape on top.
pub fn sort_generation(target_img: &image::RgbImage, current_img: &image::RgbImage, gen: &mut Vec<RandomCircle>) {
...
pub fn next_generation(target_img: &image::RgbImage, current_img: &image::RgbImage, current_gen: &Vec<RandomCircle>) -> Vec<RandomCircle> {
